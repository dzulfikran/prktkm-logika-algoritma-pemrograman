...
void login() {
	...
	gotoxy(25,12);cout<<"Username : "<<endl;
	gotoxy(25,13);cout<<"Password : ";
	gotoxy(36,12);getline(cin, username);
	gotoxy(36,13);getline(cin, password);
}
		...
		if (pilihan == 1) {
			...
			if (banyak_mhs > 0 and banyak_matkul > 0) {
				...
				do{
					...
					cout<<"Masukkan Pilihan : "; cin>>pilihan;
					if (pilihan > 0 and pilihan <= banyak_mhs) {
						n = pilihan - 1;
						system("cls");
		...
		if (pilihan == 1) {
			...
			if(banyak_matkul > 0) {
				do{
					...
					if (pilihan > 0 and pilihan <= banyak_matkul) {
						int n = pilihan - 1;
						cout<<endl<<endl;
